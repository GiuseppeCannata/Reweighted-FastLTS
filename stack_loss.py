...
df = pd.read_csv("stackloss.csv",sep=';', dtype='float32')
X = df.values[:,:-1]
y = df["stack.loss"].values
...
axs[1].set_xlabel('RD distance')
axs[1].set_ylabel('Res standardized')
